<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="cSuplidores.aspx.cs" Inherits="ProyectoFinalWeb.Consulta.cSuplidores" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class=" form-row justify-content-center">
        ...
        <div class="form-group col-md-3">
            ...
            <asp:DropDownList ID="FiltroDropDownList" Class="form-control" runat="server">
                ...
                <asp:ListItem>CuentasPorPagar</asp:ListItem>
            </asp:DropDownList>
        </div>
        <%--  Criterio--%>
        <div class="form-group col-md-3">
    ...
    <div class=" form-row justify-content-center">
        <asp:GridView ID="SuplidoresGridView" runat="server" class="table table-condensed table-bordered table-responsive" CellPadding="4" ForeColor="#333333" GridLines="None">
