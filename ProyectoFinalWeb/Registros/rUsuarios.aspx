                ...
                <article class="card-body">
                    <div class="form-group">
                        ...
                        <div class="form-gruop col-md-12">
                          ...
                          <%-- Nombre Usuario--%>
                        <div class="form-gruop col-md-12">
                            <label for="NombreUsuario" class="col-md-3 control-label input-sm">Nombre Usuario:</label>
                            <div class="col-md-7">
                                <asp:TextBox ID="NombreUsuarioTextBox" runat="server" class="form-control input-sm"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="nUsuarioRFValidator" ValidationGroup="Guardar" ControlToValidate="NombreUsuarioTextBox" runat="server" ErrorMessage="*" Display="Dynamic" ForeColor="Red">*</asp:RequiredFieldValidator>
                                <br />
                            </div>
                        </div>
                       <%--  Email--%>
                      <div class="form-gruop col-md-12">
                            ...
                            <div class="col-md-7">
                                <asp:TextBox ID="EmailTextBox" runat="server" class="form-control input-sm"></asp:TextBox>
                                 <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ValidationGroup="Guardar" ControlToValidate="NombreTextBox" runat="server" ErrorMessage="*" Display="Dynamic" ForeColor="Red">*</asp:RequiredFieldValidator>
                                <br />
                            </div>
                        </div>
                        <%-- <Contraseña>--%>
